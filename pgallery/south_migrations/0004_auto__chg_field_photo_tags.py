...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'pgallery_photo', 'tags', self.gf('djorm_pgarray.fields.ArrayField')(dbtype=u'text', null=True))

    def backwards(self, orm):

        # Changing field 'Photo.tags'
        db.alter_column(u'pgallery_photo', 'tags', self.gf('djorm_pgarray.fields.ArrayField')(dbtype=u'varchar(127)', null=True))
